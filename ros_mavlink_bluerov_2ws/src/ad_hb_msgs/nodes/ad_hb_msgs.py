...
def publish_desired_trajectory():
    ...
    while not rospy.is_shutdown():
        ...
        z_ref = -205 + amplitude_z * math.sin(2 * math.pi * frequency_z * current_time)

        # Calculate the desired heading angle (psi_ref) based on the desired trajectory
        amplitude_psi = 2  # Adjust this value as needed
        frequency_psi = 5 / period  # Adjust this value as needed
        psi_ref = -68 + amplitude_psi * math.sin(2 * math.pi * frequency_psi * current_time)
